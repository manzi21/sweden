...
const MOBILE_FIX_CSS=`
  *,*::before,*::after{box-sizing:border-box}
  ...
  img.miliTeaserAvatar{content:url("MOA_PLACEHOLDER");border-radius:50%;object-fit:cover;width:22px!important;height:22px!important;}
  img.fabAvatar{content:url("MOA_PLACEHOLDER");border-radius:50%;object-fit:cover;width:35px!important;height:35px!important;}
...
export default function RootLayout({children}:Readonly<{children:React.ReactNode}>){
  const css=MOBILE_FIX_CSS.replace(/MOA_PLACEHOLDER/g,MOA_IMG);
  return(
