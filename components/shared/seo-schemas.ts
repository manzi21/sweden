...
export const organizationSchema = {
  ...
  url: DOMAIN,
  // Use the Broadcast Star logo (variant C) — vector-perfect for Google Knowledge Panel
  logo: {
    "@type": "ImageObject",
    "@id": `${DOMAIN}/#logo`,
    url: `${DOMAIN}/logo.svg`,
    ...
    width: 512,
    height: 512,
    caption: "Sverige TV — Broadcast Star logo",
  },
...
export const faqSchema = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "Vad är bästa IPTV i Sverige 2026?", acceptedAnswer: { "@type": "Answer", text: "Sverige TV (premiumiptv.se) erbjuder 20 000+ live-kanaler i 4K UHD, 100 000+ filmer & serier, EPG på svenska, SVT, TV4, Allsvenskan, SHL, Premier League och alla stora internationella kanaler från endast 50 kr/månad." } },
    { "@type": "Question", name: "Är IPTV lagligt i Sverige?", acceptedAnswer: { "@type": "Answer", text: "Att se på IPTV som privatperson är inte olagligt i Sverige. Vi rekommenderar dock att alltid välja en seriös leverantör. Sverige TV följer alla regler och betalar moms i EU." } },
    { "@type": "Question", name: "Hur snabbt aktiveras IPTV-abonnemanget?", acceptedAnswer: { "@type": "Answer", text: "Aktiveringen sker på cirka 10 minuter via WhatsApp efter betalning. Du får M3U-länk, Xtream Codes-uppgifter samt installationsguide för din enhet." } },
    { "@type": "Question", name: "Vilka enheter fungerar med Sverige TV IPTV?", acceptedAnswer: { "@type": "Answer", text: "Sverige TV fungerar på Amazon Firestick, Smart TV (Samsung, LG, Philips, Sony), Apple TV, iPhone, iPad, Android, Android Box, MAG, Formuler, Enigma2, Kodi, VLC, PC, Mac och alla enheter som stöder M3U eller Xtream Codes." } },
    { "@type": "Question", name: "Kan jag testa IPTV gratis?", acceptedAnswer: { "@type": "Answer", text: "Ja, vi erbjuder 24 timmars gratis testperiod helt utan kortuppgifter. Kontakta oss via WhatsApp på +44 7307 410512 så aktiverar vi din testlinje inom 10 minuter." } },
    { "@type": "Question", name: "Vilka svenska kanaler ingår?", acceptedAnswer: { "@type": "Answer", text: "Alla stora svenska kanaler ingår: SVT1, SVT2, SVT24, SVT Play, TV3, TV4, TV4 Play, Kanal 5, Kanal 9, Kanal 11, TV6, TV7, TV8, TV10, TV12, Sjuan, Viaplay, Viaplay Sport, C More, Eurosport, Discovery, National Geographic m.fl." } },
    { "@type": "Question", name: "Finns ExYu, arabiska, turkiska och persiska kanaler?", acceptedAnswer: { "@type": "Answer", text: "Ja, vi har tusentals internationella kanaler: ExYu (Pink, RTS, HRT, Nova TV, Arena Sport), arabiska (MBC, Al Jazeera, OSN, beIN), turkiska (TRT, ATV, Show TV, Star TV, Kanal D), persiska (GEM TV, Manoto), kurdiska (Kurdistan TV, Rudaw), somaliska, afrikanska och många fler." } },
    { "@type": "Question", name: "Hur mycket kostar IPTV per månad?", acceptedAnswer: { "@type": "Answer", text: "Priserna börjar från 50 kr/månad för månadsabonnemang. Vid 12-månaders abonnemang blir månadskostnaden ännu lägre. Ingen bindningstid, inga dolda avgifter." } },
    { "@type": "Question", name: "Kan jag titta på flera enheter samtidigt?", acceptedAnswer: { "@type": "Answer", text: "Ja, vi erbjuder multi-connection där du kan streama på upp till 5 enheter samtidigt med ett familjeabonnemang." } },
    { "@type": "Question", name: "Hur betalar jag?", acceptedAnswer: { "@type": "Answer", text: "Vi accepterar Swish, PayPal, kort (Visa/Mastercard) och Klarna. Snabb och säker betalning." } },
    { "@type": "Question", name: "Buffrar IPTV i 4K?", acceptedAnswer: { "@type": "Answer", text: "Nej, vi använder anti-freeze-teknik och premium-servrar i Sverige och Europa. Med en internetanslutning från 25 Mbps streamar du smidigt i 4K UHD utan buffring." } },
    { "@type": "Question", name: "Vad är skillnaden mellan Sverige TV och Viaplay/Netflix?", acceptedAnswer: { "@type": "Answer", text: "Sverige TV kombinerar 20 000+ livekanaler från hela världen (sport, nyheter, film, barn) PLUS 100 000+ filmer och serier i en enda app — till bråkdelen av priset jämfört med att prenumerera på Viaplay, Netflix, HBO Max och Disney+ separat." } },
  ],
};
